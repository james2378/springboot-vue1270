...
<div class="center-preview" :style='{"width":"100%","padding":"0 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
	...
	<div class="info" :style='{"padding":"20px 40px 40px 220px","margin":"20px auto","borderRadius":"0","flexWrap":"wrap","background":"#f9f9f9","display":"flex","width":"100%","position":"relative","height":"auto"}'>
		...
		<div :style='{"borderColor":"#efefef","top":"60px","left":"80px","borderWidth":"0","width":"100px","fontSize":0,"position":"absolute","borderStyle":"solid","height":"100px"}' v-if="userTableName=='shangjia'">
			<el-image :style='{"margin":"10px auto","borderColor":"#efefef","objectFit":"cover","borderRadius":"100%","borderWidth":"0 0 1px 0","display":"block","width":"100px","borderStyle":"solid","float":"left","height":"100px"}' :src="sessionForm.shangjiafengmian?baseUrl + sessionForm.shangjiafengmian:require('@/assets/avator.png')" fit="cover"></el-image>
		</div>
		<div :style='{"borderColor":"#efefef","top":"60px","left":"80px","borderWidth":"0","width":"100px","fontSize":0,"position":"absolute","borderStyle":"solid","height":"100px"}' v-if="userTableName=='peisongyuan'">
			<el-image :style='{"margin":"10px auto","borderColor":"#efefef","objectFit":"cover","borderRadius":"100%","borderWidth":"0 0 1px 0","display":"block","width":"100px","borderStyle":"solid","float":"left","height":"100px"}' :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')" fit="cover"></el-image>
		</div>
		...
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='shangjia'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>商家账号</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":"1"}'>{{sessionForm.shangjiazhanghao}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='shangjia'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>商家名称</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":1}'>{{sessionForm.shangjiamingcheng}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='shangjia'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>商家地址</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":1}'>{{sessionForm.shangjiadizhi}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='shangjia'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>联系电话</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":1}'>{{sessionForm.lianxidianhua}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='peisongyuan'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>配送账号</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":"1"}'>{{sessionForm.peisongzhanghao}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='peisongyuan'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>配送姓名</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":1}'>{{sessionForm.peisongxingming}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='peisongyuan'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>性别</div>
		...
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='peisongyuan'">
			...
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":1}'>{{sessionForm.lianxifangshi}}</div>
		</div>
    ...
    <el-tabs tab-position="left" :style='{"width":"100%","background":"#f5f5f5","flexDirection":"column","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='shangjia'" label="商家账号" prop="shangjiazhanghao">
            <el-input v-model="sessionForm.shangjiazhanghao" placeholder="商家账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='shangjia'" label="商家名称" prop="shangjiamingcheng">
            <el-input v-model="sessionForm.shangjiamingcheng" placeholder="商家名称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='shangjia'" label="商家封面">
			<file-upload
			tip="点击上传商家封面"
			action="file/upload"
			:limit="1"
			:multiple="true"
			:fileUrls="sessionForm.shangjiafengmian?sessionForm.shangjiafengmian:''"
			@change="shangjiashangjiafengmianHandleAvatarSuccess"
			></file-upload>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='shangjia'" label="商家地址" prop="shangjiadizhi">
            <el-input v-model="sessionForm.shangjiadizhi" placeholder="商家地址" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='shangjia'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='peisongyuan'" label="配送账号" prop="peisongzhanghao">
            <el-input v-model="sessionForm.peisongzhanghao" placeholder="配送账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='peisongyuan'" label="配送姓名" prop="peisongxingming">
            <el-input v-model="sessionForm.peisongxingming" placeholder="配送姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='peisongyuan'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='peisongyuan'" label="联系方式" prop="lianxifangshi">
            <el-input v-model="sessionForm.lianxifangshi" placeholder="联系方式" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='peisongyuan'" label="头像">
			<file-upload
			tip="点击上传头像"
			action="file/upload"
			:limit="1"
			:multiple="true"
			:fileUrls="sessionForm.touxiang?sessionForm.touxiang:''"
			@change="peisongyuantouxiangHandleAvatarSuccess"
			></file-upload>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
		...
		if ('shangjia' == this.userTableName) {
			this.$set(this.sessionForm, 'shangjiafengmian', null);
		}
		if ('shangjia' == this.userTableName) {
    ...
    methods: {
      ...
      onSubmit(formName) {
		...
		if(`shangjia` == this.userTableName && this.sessionForm.shangjiafengmian!=null){
			this.sessionForm.shangjiafengmian = this.sessionForm.shangjiafengmian.replace(new RegExp(this.$config.baseUrl,"g"),"");
		}
		if(`peisongyuan` == this.userTableName && this.sessionForm.touxiang!=null){
			this.sessionForm.touxiang = this.sessionForm.touxiang.replace(new RegExp(this.$config.baseUrl,"g"),"");
		}
      ...
      shangjiashangjiafengmianHandleAvatarSuccess(fileUrls) {
        this.sessionForm.shangjiafengmian = fileUrls;
      },
      peisongyuantouxiangHandleAvatarSuccess(fileUrls) {
        this.sessionForm.touxiang = fileUrls;
      },
