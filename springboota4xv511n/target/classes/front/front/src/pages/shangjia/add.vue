...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="商家封面" v-if="type!='cross' || (type=='cross' && !ro.shangjiafengmian)" prop="shangjiafengmian">
            <file-upload
            tip="点击上传商家封面"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' class="upload" v-else label="商家封面" prop="shangjiafengmian">
                ...
                <img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangjiafengmian.split(',')" :src="baseUrl+item" width="100" height="100">
            </el-form-item>
  ...
  export default {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='shangjiafengmian'){
              this.ruleForm.shangjiafengmian = obj[o].split(",")[0];
    ...
    // 多级联动参数
      ...
      shangjiafengmianUploadChange(fileUrls) {
          this.ruleForm.shangjiafengmian = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
    }
  };
</script>
