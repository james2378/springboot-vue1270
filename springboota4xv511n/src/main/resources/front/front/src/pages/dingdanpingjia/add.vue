    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="接单时间" prop="jiedanshijian">
            <el-input v-model="ruleForm.jiedanshijian" 
                placeholder="接单时间" clearable :disabled=" false  ||ro.jiedanshijian"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="完成时间" prop="wanchengshijian">
            <el-input v-model="ruleForm.wanchengshijian" 
                placeholder="完成时间" clearable :disabled=" false  ||ro.wanchengshijian"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}'  label="订单评价" prop="dingdanpingjia">
            <el-select v-model="ruleForm.dingdanpingjia" placeholder="请选择订单评价" :disabled=" false  ||ro.dingdanpingjia" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="评价内容" prop="pingjianeirong">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="评价内容"
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('dingdanpingjia/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`dingdanpingjia/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
