...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}'  label="鲜花类型" prop="xianhualeixing">
            <el-select v-model="ruleForm.xianhualeixing" placeholder="请选择鲜花类型" :disabled=" false  ||ro.xianhualeixing" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}'  label="鲜花寓意" prop="xianhuayuyi">
            <el-select v-model="ruleForm.xianhuayuyi" placeholder="请选择鲜花寓意" :disabled=" false  ||ro.xianhuayuyi" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}'  label="赠送对象" prop="zengsongduixiang">
            <el-select v-model="ruleForm.zengsongduixiang" placeholder="请选择赠送对象" :disabled=" false  ||ro.zengsongduixiang" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="上架日期" prop="shangjiariqi">
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="数量" prop="shuliang">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="鲜花详情" prop="xianhuaxiangqing">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="鲜花详情"
