	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#e9ecf3"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="配送接单" prop="peisongjiedan">
					<el-select :disabled="ro.peisongjiedan" v-model="ruleForm.peisongjiedan" placeholder="请选择配送接单" >
						<el-option
							v-for="(item,index) in peisongjiedanOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="配送接单" prop="peisongjiedan">
					<el-input v-model="ruleForm.peisongjiedan"
						placeholder="配送接单" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="备货时间" prop="beihuoshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.beihuoshijian" 
						type="datetime"
						:readonly="ro.beihuoshijian"
						placeholder="备货时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.beihuoshijian" label="备货时间" prop="beihuoshijian">
...
export default {
	...
	created() {
		this.ruleForm.beihuoshijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='peisongjiedan'){
							this.ruleForm.peisongjiedan = obj[o];
							this.ro.peisongjiedan = true;
							continue;
						}
						if(o=='beihuoshijian'){
				...
				this.ruleForm.peisongjiedan = '未接单'; 
			}
            ...
            this.peisongjiedanOptions = "已接单,未接单".split(',')
