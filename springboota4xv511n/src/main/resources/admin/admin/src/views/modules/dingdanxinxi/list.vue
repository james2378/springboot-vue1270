		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"border":"0px solid #ddd","padding":"20px 20px 0","margin":"0px 0 0","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"auto","fontSize":"inherit","justifyContent":"space-between"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0px","margin":"0 0 10px","borderRadius":"0px","textAlign":"center","flexWrap":"wrap","background":"#fff","flexDirection":"row","display":"flex","width":"auto","fontSize":"inherit","order":"2"}' >
					...
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"flex"}' class="select" label="备货状态" prop="beihuozhuangtai">
						<label :style='{"margin":"0 10px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">备货状态</label>
						<el-select clearable v-model="searchForm.beihuozhuangtai" placeholder="请选择备货状态" >
							<el-option v-for="(item,index) in beihuozhuangtaiOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
			...
			<div :style='{"border":"0px solid #bababa","padding":"0","margin":"0 0 0 0","borderRadius":"2px","background":"rgba(255,255,255,1)","width":"calc(100% - 0px)","float":"right"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true'  
						prop="beihuozhuangtai"
						label="备货状态">
						<template slot-scope="scope">
							{{scope.row.beihuozhuangtai}}
						</template>
					</el-table-column>
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('dingdanxinxi','备货')" @click="peisongdingdanCrossAddOrUpdateHandler(scope.row,'cross','否','是','beihuozhuangtai','已备货','已备货,未备货'.split(',')[0])" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","display":"inline-block"}'></span>
								备货
							</el-button>
...
import peisongdingdanCrossAddOrUpdate from "../peisongdingdan/add-or-update";
	export default {
		...
		methods: {
			...
			peisongdingdanCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
    ...
    params['order'] = 'desc';
           if(this.searchForm.beihuozhuangtai!='' && this.searchForm.beihuozhuangtai!=undefined){
            params['beihuozhuangtai'] = this.searchForm.beihuozhuangtai
          }
