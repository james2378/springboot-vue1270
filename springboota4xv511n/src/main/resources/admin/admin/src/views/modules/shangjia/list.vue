		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #bababa","padding":"0","margin":"0 0 0 0","borderRadius":"2px","background":"rgba(255,255,255,1)","width":"calc(100% - 0px)","float":"right"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<!-- 无 -->
					<el-table-column :resizable='true' :sortable='true' prop="shangjiafengmian" width="200" label="商家封面">
						<template slot-scope="scope">
							<div v-if="scope.row.shangjiafengmian">
								<img v-if="scope.row.shangjiafengmian.substring(0,4)=='http'" :src="scope.row.shangjiafengmian.split(',')[0]" width="100" height="100">
								<img v-else :src="$base.url+scope.row.shangjiafengmian.split(',')[0]" width="100" height="100">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
